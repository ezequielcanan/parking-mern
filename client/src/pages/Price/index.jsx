      ...
      {!loading ? (
        <form className="flex flex-col gap-y-[40px]" onSubmit={handleSubmit(onSubmit)}>
          <div className="flex justify-between">
            <label className="text-fourth text-xl md:text-3xl pr-[10px] md:pr-[40px]" htmlFor="hourPrice">Hour:</label>
            <input className="py-2 px-3 text-xl md:text-2xl" type="number" step={"any"} {...register("hourPrice")} />
          </div>
          <div className="flex justify-between">
            <label className="text-fourth text-xl md:text-3xl pr-[10px] md:pr-[40px]" htmlFor="dayPrice">Day:</label>
            <input className="py-2 px-3 text-xl md:text-2xl" type="number" step={"any"} {...register("dayPrice")} />
          </div>
          <div className="flex justify-between">
            <label className="text-fourth text-xl md:text-3xl pr-[10px] md:pr-[40px]" htmlFor="fractionPrice">Fraction:</label>
            <input className="py-2 px-3 text-xl md:text-2xl" type="number" step={"any"} {...register("fractionPrice")} />
          </div>
